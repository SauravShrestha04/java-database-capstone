...
//    - Spring Data JPA automatically implements this repository, providing the necessary CRUD functionality and custom queries defined in the interface.
    ...
    // Appointments for a doctor in a time range (with doctor + availability eagerly fetched)
    @Query("""
           SELECT a
           FROM Appointment a
    ...
    // Appointments for a doctor, filtered by partial patient name (case-insensitive) and time range
    @Query("""
           SELECT a
           FROM Appointment a
           LEFT JOIN FETCH a.doctor d
    ...
    // Appointments for a patient with given status, ordered by time
