...
//      - The @Email annotation validates that the email address follows a valid email format.
//
// 5. 'password' field:
//    - Type: private String
//    - Description:
...
//      - The @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) annotation ensures that the password is not serialized in responses.
//
// 6. 'phone' field:
//    - Type: private String
//    - Description:
...
//      - The @ElementCollection annotation stores these values in a separate collection table.
//
