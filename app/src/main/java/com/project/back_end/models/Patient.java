...
//      - The @Pattern(regexp = "^[0-9]{10}$") annotation validates that the phone number must be exactly 10 digits.
//
// 6. 'address' field:
//    - Type: private String
//    - Description:
...
//      - The @Size(max = 255) annotation ensures that the address does not exceed 255 characters.
//
