...
public class Prescription {
  ...
  //      - The @Size(min = 3, max = 20) annotation ensures that the dosage length is between 3 and 20 characters.
  ...
  // 7. Constructors:
  //    - The class includes a no-argument constructor (default constructor) and a parameterized constructor that initializes the fields:
